public class DecisionTree {
	private class Node {
		...
		public Node(int newNodeID, String newQuestAns, int answersCount, String[][] responses) {
	...
	public void addNewLeafNode(int parentID, int newID, String answer, String[][] responses) {
		if (parentID == 1) {
	...
	private void searchAndAddAnswer(Node currentNode, int parentID, int newID,
		...
		if (currentNode != null && currentNode.nodeID == parentID) {
			...
			for (int i = 0; i < currentNode.entries; i++) {
				System.out.println("LOOKING THROUGH ENTRIES: " + currentNode);
